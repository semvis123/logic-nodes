<script lang="ts">
	...
	const guides = [
		...
		{ href: '/counters', name: 'Counters', blurb: 'Ripple, synchronous, decade and up/down, and why each bit halves.' },
		{
			...
			blurb: 'Serial and parallel, plus ring and Johnson counters.'
		},
		{
			href: '/common-circuits',
			name: 'Common circuits',
			blurb: 'Adders, multiplexers, decoders, comparators and parity.'
		},
		{
			href: '/boolean-algebra-laws',
			name: 'Boolean algebra laws',
			blurb: 'Every identity, each proved with a generated truth table.'
		},
		{
			href: '/practice',
			name: 'Practice and worksheets',
			blurb: 'Endless generated questions, and printable sheets with a key.'
		}
	];
...
>
	...
	<section class="features" id="features">
		...
		<div class="mid-cta">
			<a class="cta" href="/simulator">Try it now</a>
	...
	<section>
		...
		<p class="section-intro">
			Every table, identity and waveform on these pages is generated by the same engine that powers the tools, and
			checked against it, so none of it can quietly go stale.
		</p>
		<div class="link-grid">
	...
	<section class="final-cta">
		...
		<a class="cta big" href="/simulator">Open the simulator</a>
		<p class="reducer">
