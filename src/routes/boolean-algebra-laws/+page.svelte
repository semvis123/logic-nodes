<script lang="ts">
	...
	const page = {
		...
		imageAlt: 'LogicGates.org: boolean algebra laws'
	};
...
>
	...
	<section>
		...
		<p class="section-intro">Every identity on one sheet, black on white, for printing or a slide.</p>
		{#each imagesFor('/boolean-algebra-laws') as shot}
